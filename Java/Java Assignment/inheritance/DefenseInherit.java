...
class Defence
{
	...
	Defence()
	{
	 ...
	 public Defence(String nameOfHead, int nooftrrops, double budget, int noofdept, int noofvehicle,
...
class Airforce extends Defence
{
 ...
 class DefenseInherit {
	...
	public static void main(String[] args) {
		...
		Army a2=new Army("AWS",42,852000,20,100,"US","USA",30,50,30,45,200,623,478);
		a2.display();
		System.out.println("\n\n");
		...
		Navy n2=new Navy("QSW",46,452000,36,100,"UK","USA",33,53,47,100,60,85);
		n2.display();
		System.out.println("\n\n");
		...
		Airforce f2=new Airforce("FRD",82,9652000,45,100,"Canada","USA",30,93,75,800,65,200);
		f2.display();
		System.out.println("\n\n");
